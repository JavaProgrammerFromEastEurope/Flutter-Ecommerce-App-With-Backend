...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        // 🔹 Реактивный слайдер популярных товаров
        Obx(() {
          if (!popularController.isLoaded.value) {
            return const Center(
        ...
        // 🔹 Реактивный список рекомендованных товаров
        Obx(() {
          if (!recommendedController.isLoaded.value) {
            return const Center(
              child: CircularProgressIndicator(),
            );
          }
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var product = recommendedController.recommendedProductList[index];
                ...
                child: Padding(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize
                        .min, // Чтобы Column сжималась по содержимому
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      BigText(
