      ...
      child: Stack(
        children: [
          Container(
            ...
            margin: const EdgeInsets.only(left: Dimensions.width10, right: Dimensions.width10),
          ...
          Align(
            ...
            child: Container(
              ...
              margin: const EdgeInsets.only(left: Dimensions.width30, right: Dimensions.width30, bottom: Dimensions.height20),
              decoration: BoxDecoration(
