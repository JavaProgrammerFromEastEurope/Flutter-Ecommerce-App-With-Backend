        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Column(children: [
              Container(
                child: ExpandableTextWidget(text: "Tender cuts of chicken are bathed in a rich, creamy yogurt marinade infused with a bold blend of spices. Fragrant garlic and ginger combine with warm notes of cumin, coriander, paprika, and a hint of chili to create a depth of flavor that penetrates every bite. The yogurt not only tenderizes the meat but also locks in moisture, ensuring the chicken remains juicy and succulent during cooking.
